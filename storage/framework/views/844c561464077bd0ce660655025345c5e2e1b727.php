                ...
                <div class="ibox-content">
                    <form method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="flag" class="form-control"><span class="help-block m-b-none">用于检测获取到的页面是否是正确数据</span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="min_num" class="form-control" placeholder="30"><span class="help-block m-b-none">用于控制ip库保证有足够多有效ip可用</span>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
